# 🚗 Used Car Price Prediction – Advanced Ensemble ML Project
...
- **Cascading UI:** Real-time dependent dropdowns (Manufacturer → Category → Model) for a premium user experience.
...
## 🤖 Model Architecture: The "Tuned Trio"
